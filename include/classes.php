	...
	function settings_site_manager_callback()
	{
		...
		function setting_site_manager_multisite_callback()
		{
			...
			echo "<ol>
				...
				<li>
					<strong><a href='/wp-admin/plugins.php'".make_link_external().">".__("Deactivate all plugins", 'lang_site_manager')."</a></strong>
					<br><br>
				</li>
				<li>
					<strong><a href='/wp-admin/network.php'".make_link_external().">".__("Go to Network Settings", 'lang_site_manager')."</a></strong>
				...
				<li>
					<strong><a href='/wp-admin/'".make_link_external().">".__("Login", 'lang_site_manager')."</a></strong>
					<br><br>
				</li>
				<li>
					<strong><a href='/wp-admin/network/plugins.php'".make_link_external().">".__("Activate all plugins", 'lang_site_manager')."</a></strong>
					<br><br>
				</li>
			</ul>";
		}
